...
from weather import func_temperature_today
...
class My_prognozApp(App):
    ...
    def __init__(self, city_search):
        ...
        self.city_input = TextInput(multiline=False, hint_text="Введите город", text=city_search)
...
def func_start(city):
    my_app = My_prognozApp(city_search=city)
    my_app.run()
